...
struct __type_traits{
    // 当编译器有能力自动特化时报错可以看懂
    typedef __is_True this_dummy_member_must_be_first;

    typedef __is_False has_trivial_constructor;
    typedef __is_False has_trivial_copy_constructor;
    typedef __is_False has_trivial_assignment_operator;
    typedef __is_False has_trivial_destructor;
    typedef __is_False is_POD_type;
};
...
struct __type_traits<T*>{
    ...
    typedef __is_True has_trivial_constructor;
    typedef __is_True has_trivial_copy_constructor;
    typedef __is_True has_trivial_assignment_operator;
    typedef __is_True has_trivial_destructor;
    typedef __is_True is_POD_type;
};
